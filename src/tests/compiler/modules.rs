...
(defun G (X) (* X 3))"}
    ...
    assert_eq!(
        source_opts.get_written_file("resources/tests/module/programs/two-outputs_F.hex"),
        None
    );
    ...
    assert_eq!(
        source_opts.get_written_file("resources/tests/module/programs/two-outputs_F.hex"),
        Some(b"ff02ffff01ff10ff05ffff010180ffff04ffff01ff10ff05ffff010180ff018080".to_vec())
    );
}
